...
img = cv2.imread('./temps/image_0.jpg', 0)
...
plt.imsave('./temps/pre_version.png', pre_version)

# read the pre-version
img = cv2.imread('./temps/pre_version.png', 0)
# ensure binary
img = cv2.threshold(img, 0, 255, cv2.THRESH_BINARY_INV | cv2.THRESH_OTSU)[1]
# save the the result
cv2.imwrite("./temps/signature.png", img)